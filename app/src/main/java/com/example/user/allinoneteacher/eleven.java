...
public class eleven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(eleven.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toSpeech.speak("T W E L V E twelve",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(eleven.this,twelve.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("T E N ten",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(eleven.this,ten.class);
                startActivity(i2);
            }
        });
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("eleven",TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("eleven") || str.equals("11") )
                    {
                        Intent i1=new Intent(eleven.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(eleven.this,wrong.class);
                        startActivity(i2);
                    }
