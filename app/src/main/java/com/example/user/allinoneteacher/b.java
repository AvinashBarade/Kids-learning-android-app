...
public class b extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(b.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        im.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("This is are some examples of words starts with b",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(b.this,bex.class);
                startActivity(i2);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("be") || str.equals("B") )
                    {
                        Intent i1=new Intent(b.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(b.this,wrong.class);
                        startActivity(i2);
                    }
