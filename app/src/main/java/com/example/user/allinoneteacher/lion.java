...
public class lion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dvoice=MediaPlayer.create(this,R.raw.lion);
        toSpeech=new TextToSpeech(lion.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dvoice.stop();
                toSpeech.speak("This is a cat",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(lion.this,cat.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {dvoice.stop();
                toSpeech.speak("This is a tiger",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(lion.this,tiger.class);
                startActivity(i2);
            }
        });
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {dvoice.stop();
                toSpeech.speak("lion",TextToSpeech.QUEUE_FLUSH,null);
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("lion") )
                    {
                        Intent i1=new Intent(lion.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(lion.this,wrong.class);
                        startActivity(i2);
                    }
