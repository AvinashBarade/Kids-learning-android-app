...
public class thirteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(thirteen.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toSpeech.speak("Wait some time for update more numbers",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(thirteen.this,wt.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(thirteen.this,twelve.class);
                startActivity(i2);
            }
        });
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("thirteen",TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("thirteen") || str.equals("13") )
                    {
                        Intent i1=new Intent(thirteen.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(thirteen.this,wrong.class);
                        startActivity(i2);
                    }
