...
public class cat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dvoice=MediaPlayer.create(this,R.raw.cat);
        ImageView next= (ImageView) findViewById(R.id.next);
        ImageView pri= (ImageView) findViewById(R.id.pri);
        ImageView img= (ImageView) findViewById(R.id.i11);
        toSpeech=new TextToSpeech(cat.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(cat.this,fish.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i3=new Intent(cat.this,lion.class);
                startActivity(i3);
            }
        });
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {dvoice.stop();
                toSpeech.speak("cat",TextToSpeech.QUEUE_FLUSH,null);
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("cat") )
                    {
                        Intent i1=new Intent(cat.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(cat.this,wrong.class);
                        startActivity(i2);
                    }
