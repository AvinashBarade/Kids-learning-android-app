...
public class square extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(square.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(square.this,star.class);
                startActivity(i2);
            }
        });
        ...
        im.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("This is a some examples of square",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(square.this,sq.class);
                startActivity(i2);
            }
        });
        pri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("T R I A N G L E triangle",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(square.this,triangle.class);
                startActivity(i2);
            }
        });
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("square",TextToSpeech.QUEUE_FLUSH,null);
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    {
                        Intent i1=new Intent(square.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(square.this,wrong.class);
                        startActivity(i2);
                    }
