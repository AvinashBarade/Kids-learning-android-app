...
public class four extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(four.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toSpeech.speak("F I V E five",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(four.this,five.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("T H R double E three",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(four.this,Three.class);
                startActivity(i2);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("four") || str.equals("4") )
                    {
                        Intent i1=new Intent(four.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(four.this,wrong.class);
                        startActivity(i2);
                    }
