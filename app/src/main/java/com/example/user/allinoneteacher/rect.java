...
TextToSpeech toSpeech;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(rect.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        im3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toSpeech.speak("This is a television", TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        ...
        im5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("This is a currency", TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        ...
        im6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("This is a mobile", TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        ...
        im7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("This is a black board", TextToSpeech.QUEUE_FLUSH,null);
            }
        });
