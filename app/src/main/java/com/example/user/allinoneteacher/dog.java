...
public class dog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer dvoice=MediaPlayer.create(this,R.raw.dog);


        toSpeech=new TextToSpeech(dog.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(dog.this,tiger.class);
                startActivity(i2);
            }
        });
        ...
        img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               // dvoice=MediaPlayer.create(this,R.raw.dog);
                dvoice.start();
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dvoice.stop();
                toSpeech.speak("dog",TextToSpeech.QUEUE_FLUSH,null);
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("dog") )
                    {
                        Intent i1=new Intent(dog.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(dog.this,wrong.class);
                        startActivity(i2);
                    }
