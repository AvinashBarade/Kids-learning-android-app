...
public class u extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(u.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toSpeech.speak("V",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(u.this,v.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(u.this,t.class);
                startActivity(i2);
            }
        });
        ...
        sb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("U",TextToSpeech.QUEUE_FLUSH,null);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("U") || str.equals("u") || str.equals("you") )
                    {
                        Intent i1=new Intent(u.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(u.this,wrong.class);
                        startActivity(i2);
                    }
