...
public class seven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(seven.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(seven.this,eight.class);
                startActivity(i2);
            }
        });
        ...
        pri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("S I X six",TextToSpeech.QUEUE_FLUSH,null);
                Intent i2=new Intent(seven.this,six.class);
                startActivity(i2);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    if(str.equals("seven") || str.equals("7") )
                    {
                        Intent i1=new Intent(seven.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(seven.this,wrong.class);
                        startActivity(i2);
                    }
