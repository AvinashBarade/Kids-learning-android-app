...
public class rectangle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toSpeech=new TextToSpeech(rectangle.this, new TextToSpeech.OnInitListener() {
            @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i2=new Intent(rectangle.this,triangle.class);
                startActivity(i2);
            }
        });
        ...
        im.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toSpeech.speak("This is an some examples of rectangle",TextToSpeech.QUEUE_FLUSH,null);
                Intent i=new Intent(rectangle.this,rect.class);
                startActivity(i);
            }
        });
        ...
        switch (reqcode) {
            case RCSO: {
                if (resultcode == RESULT_OK && null != data) {
                    ...
                    {
                        Intent i1=new Intent(rectangle.this,correct.class);
                        startActivity(i1);
                    }
                    else
                    {

                        Intent i2=new Intent(rectangle.this,wrong.class);
                        startActivity(i2);
                    }
